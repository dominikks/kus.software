...
<main class="container">
  ...
  <p>
    ...
    particularly high priority for the management of the Dominik Kus. The use of the Internet pages
    of the Dominik Kus is possible without any indication of personal data; however, if a data
  ...
  <p>
    ...
    Dominik Kus. By means of this data protection declaration, our enterprise would like to inform
  ...
  <p>
    ...
    in case of a cyber-attack. Therefore, the Dominik Kus analyzes anonymously collected data and
  ...
  <ul style="list-style: none;">
    ...
    <li>
      ...
      <p>
        ...
        erasure of personal data stored by the Dominik Kus, he or she may, at any time, contact any
        employee of the controller. An employee of Dominik Kus shall promptly ensure that the
      ...
      <p>
        ...
        as processing is not required. An employees of the Dominik Kus will arrange the necessary
    ...
    <li>
      ...
      <p>
        ...
        direct marketing. If the data subject objects to the Dominik Kus to the processing for
        direct marketing purposes, the Dominik Kus will no longer process the personal data for
        these purposes.
      </p>

      <p>
        In addition, the data subject has the right, on grounds relating to his or her particular
        situation, to object to processing of personal data concerning him or her by the Dominik Kus
      ...
      <p>
        ...
        Dominik Kus. In addition, the data subject is free in the context of the use of information
    ...
    <li>
      ...
      <p>
        ...
        any time, contact any employee of the Dominik Kus.
      </p>
    </li>
  </ul>
  ...
  <p>
    ...
    data by Matomo and the chance to preclude any such. For this, the data subject must set a "Do
