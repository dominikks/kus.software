<div class="wrapper">
  <main>
    ...
    <p>
      Dominik Kus<br />
      Steuerberatung Kus<br />
      Am Rosenhügel 39<br />
      42553 Velbert<br />
      Germany
    </p>
    <p>
      Phone: +49 15678 649380<br />
    ...
    <p>
      ...
      particularly high priority for the management of the Dominik Kus. The use of the Internet
      pages of the Dominik Kus is possible without any indication of personal data; however, if a
    ...
    <p>
      ...
      the Dominik Kus. By means of this data protection declaration, our enterprise would like to
    ...
    <p>
      As the controller, the Dominik Kus has implemented numerous technical and organizational
    ...
    <p>
      ...
      to data protection is: Dominik Kus (address and contact details can be found in the imprint
      above).
    </p>
    ...
    <p>
      When using these general data and information, the Dominik Kus does not draw any conclusions
      ...
      prosecution in case of a cyber-attack. Therefore, the Dominik Kus analyzes anonymously
    ...
    <ul style="list-style: none;">
      ...
      <li>
        ...
        <p>
          ...
          erasure of personal data stored by the Dominik Kus, he or she may, at any time, contact
          any employee of the controller. An employee of Dominik Kus shall promptly ensure that the
        ...
        <p>
          ...
          personal data, as far as processing is not required. An employees of the Dominik Kus will
      ...
      <li>
        ...
        <p>
          ...
          restriction of the processing of personal data stored by the Dominik Kus, he or she may at
          any time contact any employee of the controller. The employee of the Dominik Kus will
      ...
      <li>
        ...
        <p>
          ...
          any employee of the Dominik Kus.
        </p>
      </li>
      <li>
        ...
        <p>
          The Dominik Kus shall no longer process the personal data in the event of the objection,
        ...
        <p>
          If the Dominik Kus processes personal data for direct marketing purposes, the data subject
          ...
          such direct marketing. If the data subject objects to the Dominik Kus to the processing
          for direct marketing purposes, the Dominik Kus will no longer process the personal data
          for these purposes.
        </p>

        <p>
          In addition, the data subject has the right, on grounds relating to his or her particular
          situation, to object to processing of personal data concerning him or her by the Dominik
          Kus for scientific or historical research purposes, or for statistical purposes pursuant
        ...
        <p>
          ...
          Dominik Kus. In addition, the data subject is free in the context of the use of
      ...
      <li>
        ...
        <p>
          ...
          explicit consent, the Dominik Kus shall implement suitable measures to safeguard the data
        ...
        <p>
          ...
          decision-making, he or she may, at any time, contact any employee of the Dominik Kus.
        </p>
      </li>
      <li>
        ...
        <p>
          ...
          at any time, contact any employee of the Dominik Kus.
        </p>
      </li>
    </ul>
    ...
    <p>
      ...
      software tool for web analysis. Web analysis is the collection, gathering and evaluation of
      data on the behavior of visitors from Internet sites. A web analysis tool collects, inter
      alia, data on the website from which a data subject came to a website (so-called referrer),
      which pages of the website were accessed or how often and for which period of time a sub-page
      was viewed. A web analysis is mainly used for the optimization of a website and the
    ...
    <p>
      Matomo sets a cookie on the information technology system of the data subject. The definition
      of cookies is explained above. With the setting of the cookie, an analysis of the use of our
    ...
    <p>
      ...
      Internet pages, these personal data, including the IP address of the Internet access used by
      the data subject, are transferred to our server. These personal data will be stored by us. We
      do not forward this personal data to third parties.
    </p>
    ...
    <p>
      ...
      deny the setting of cookies. Such an adjustment to the used Internet browser would also
      prevent Matomo from setting a cookie on the information technology system of the data subject.
      In addition, cookies already in use by Matomo may be deleted at any time via a web browser or
      other software programs.
    </p>

    <p>
      In addition, the data subject has the possibility of objecting to a collection of data
      relating to a use of this Internet site that are generated by Matomo as well as the processing
      of these data by Matomo and the chance to preclude any such. For this, the data subject must
      set a "Do Not Track" option in the browser.
    </p>

    <p>
      With each setting of the opt-out cookie, however, there is the possibility that the websites
      of the controller are no longer fully usable for the data subject.
    </p>
    ...
    <h4>
      10. Provision of personal data as statutory or contractual requirement; Requirement necessary
