...
<style lang="scss">
	...
	.profile img {
		...
		box-shadow: 2.4px 2.4px 2.7px rgba(0, 0, 0, 0.022), 6.1px 6.1px 6.9px rgba(0, 0, 0, 0.031),
			12.4px 12.4px 14.2px rgba(0, 0, 0, 0.039), 25.6px 25.6px 29.2px rgba(0, 0, 0, 0.048),
